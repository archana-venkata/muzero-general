...
class MuZeroConfig:
    def __init__(self):
        ...
        self.env_name = "SimpleMinecraft-v0"
        ...
        ### Game
        self.observation_shape = (1, 1, 151)  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
